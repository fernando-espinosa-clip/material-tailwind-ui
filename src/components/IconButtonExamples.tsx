    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-4 items-center">
          <IconButton
            icon={<Star />}
            color="primary"
            aria-label="Estrella primaria"
          />
          <IconButton
            icon={<Bell />}
            color="secondary"
            aria-label="Campana secundaria"
          />
          <IconButton
            icon={<AlertCircle />}
            color="error"
            aria-label="Alerta de error"
          />
          <IconButton
            icon={<AlertCircle />}
            color="warning"
            aria-label="Alerta de advertencia"
          />
          <IconButton
            icon={<Send />}
            color="info"
      ...
      <div>
        <h2 className="text-xl font-semibold mb-2">
          IconButtons con Variantes y Colores
        </h2>
        <div className="flex flex-wrap gap-4 items-center">
          <IconButton
            icon={<Star />}
      ...
      <div>
        <h2 className="text-xl font-semibold mb-2">
          IconButtons Deshabilitados
        </h2>
        <div className="flex flex-wrap gap-4">
          <IconButton
            icon={<Heart />}
            disabled
            aria-label="Favorito deshabilitado"
          />
          <IconButton
            icon={<Settings />}
            variant="solid"
