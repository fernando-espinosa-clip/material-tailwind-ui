...
const button = tv({
  ...
  compoundVariants: [
    ...
    },
    {
      variant: "contained",
      color: "primary",
      class: "bg-primary-500 text-white hover:bg-primary-600 disabled:bg-primary-300",
    },
    {
      variant: "contained",
      color: "secondary",
      class: "bg-secondary-500 text-white hover:bg-secondary-600 disabled:bg-secondary-300",
    },
    {
      variant: "contained",
      color: "error",
    ...
    },
    {
      variant: "contained",
      color: "warning",
      class: "bg-warning-500 text-black hover:bg-warning-600 disabled:bg-warning-300",
    },
    {
      variant: "contained",
      color: "info",
    ...
    },
    {
      variant: "contained",
      color: "success",
      class: "bg-success-500 text-white hover:bg-success-600 disabled:bg-success-300",
    },
    // Text button colors
    {
      variant: "text",
    ...
    },
    {
      variant: "text",
      color: "secondary",
      class: "text-secondary-500 hover:bg-secondary-50 disabled:text-secondary-300",
    },
    {
      variant: "text",
      color: "error",
    ...
    // Outlined button colors
    {
      variant: "outlined",
      color: "default",
      class: "border-grey-300 text-grey-800 hover:bg-grey-100 disabled:text-grey-400 disabled:border-grey-200",
    },
    {
      variant: "outlined",
      color: "primary",
    ...
    },
    {
      variant: "outlined",
      color: "error",
      class: "border-error-500 text-error-500 hover:bg-error-50 disabled:text-error-300 disabled:border-error-200",
    },
    {
      variant: "outlined",
      color: "warning",
    ...
    },
    {
      variant: "outlined",
      color: "info",
      class: "border-info text-info hover:bg-info/10 disabled:text-info/50 disabled:border-info/30",
    },
    {
      variant: "outlined",
      color: "success",
...
export const Button: ButtonComponent = React.forwardRef(
  <C extends React.ElementType = "button">(
    ...
    return (
      <Comp className={button({ variant, color, size, fullWidth, className })} ref={ref} {...props}>
