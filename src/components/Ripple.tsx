...
export const Ripple: React.FC<RippleProps> = ({ duration = 500, color = "rgba(255, 255, 255, 0.3)" }) => {
  ...
  return (
    <span className="absolute inset-0 overflow-hidden rounded-[inherit] z-0" onMouseDown={addRipple}>
